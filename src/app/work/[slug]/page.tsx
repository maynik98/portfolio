...
export default async function CasePage({ params }: CasePageProps) {
  ...
  const meta = [
    { label: "Проект", value: project.title },
    { label: "Тип проекта", value: project.categories.join(" · ") },
    { label: "Компания", value: company ? company.name : "Other" },
    project.year ? { label: "Год", value: project.year } : null,
    project.role ? { label: "Моя роль", value: project.role } : null,
    ...
    <article>
        ...
        <section className="border-t border-hairline">
          <div className="mx-auto w-full max-w-6xl px-6 py-20 md:px-10 md:py-28">
            <div className="grid gap-10 md:grid-cols-12 md:gap-16">
              <BlockLabel className="md:col-span-3">Задача</BlockLabel>
      ...
      {project.process && project.process.length > 0 && (
        <section className="border-t border-hairline bg-surface">
          <div className="mx-auto w-full max-w-6xl px-6 py-20 md:px-10 md:py-28">
            <div className="grid gap-10 md:grid-cols-12 md:gap-16">
              <BlockLabel className="md:col-span-3">Процесс</BlockLabel>
      ...
      {project.solution && project.solution.length > 0 && (
        <section className="border-t border-hairline">
          <div className="mx-auto w-full max-w-6xl px-6 py-20 md:px-10 md:py-28">
            <div className="grid gap-10 md:grid-cols-12 md:gap-16">
              <BlockLabel className="md:col-span-3">Решение</BlockLabel>
      ...
      {project.results.length > 0 && (
        <section className="border-t border-hairline">
          <div className="mx-auto w-full max-w-6xl px-6 py-20 md:px-10 md:py-28">
            <BlockLabel>Результат</BlockLabel>
